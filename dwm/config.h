...
static const char col_gray2[]       = "#005f85";
//font color
static const char col_gray3[]       = "#c5c8c6";
//current tag and current window fon color
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_cyan,  col_cyan  },
        ...
        [SchemeTagsSel]  = { col_gray4, "#3971ed",  col_gray3  }, // Tagbar left selected {text,background,not used but cannot be empty}
    [SchemeTagsNorm]  = { col_gray3, col_gray1,  col_gray3  }, // Tagbar left unselected {text,background,not used but cannot be empty}
    [SchemeInfoSel]  = { col_gray3, "#3971ed",  "#3971ed"  }, // infobar middle  selected {text,background,not used but cannot be empty}
